    ...
    public partial class PasswordSite : Form
    {
        ...
        private void Data(bool direction)
        {
            if (direction)
            {
                ...
                this.tbMobile.Text = this.Mobile;
                this.tbMail.Text = this.Mail;
            ...
            else
            {
                ...
                this.Mobile = this.tbMobile.Text;
                this.Mail = this.tbMail.Text;
            }
        }


        public void InitData(string title, string link, string user, string password, string mobile, string mail, string description)
        {
            this.Title = title;
            this.Link = link;
            this.User = user;
        ...
        private void btview_Click(object sender, EventArgs e)
        {
            if (this.tbPassword.PasswordChar == '*')
            {
                ...
                this.btview.Text = "隐藏密码";
            }
            else
            {
                this.tbPassword.PasswordChar = '*';
                this.btview.Text = "显示密码";
            }
        }
