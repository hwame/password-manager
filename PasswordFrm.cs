    ...
    public partial class PasswordFrm : Form
    {
        ...
        private void PasswordFrm_Load(object sender, EventArgs e)
        {
            ...
            foreach (var item in this.PasswordRecord.Records)
            {
                ...
                lvi.SubItems.Add("******");
                lvi.SubItems.Add(pi.Mobile);
                lvi.SubItems.Add(pi.Mail);
        ...
        private void tsbNew_Click(object sender, EventArgs e)
        {
            ...
            if (frm.ShowDialog(this) == DialogResult.OK)
            {
                ...
                item.SubItems.Add("******");
                item.SubItems.Add(frm.Mobile);
                item.SubItems.Add(frm.Mail);
        ...
        private void SiteEdit(ListViewItem item)
        {
            ...
            string mobile = item.SubItems[4].Text;
            string mail = item.SubItems[5].Text;
            string description = item.SubItems[6].Text;

            frm.InitData(title, link, user,password, mobile, mail,description);
            ...
            if (frm.ShowDialog(this) == DialogResult.OK)
            {
                ...
                item.Tag = frm.Password;
                item.SubItems[4].Text = frm.Mobile;
                item.SubItems[5].Text = frm.Mail;
                item.SubItems[6].Text = frm.Description;
        ...
        private void save()
        {
            ...
            for (var i = 0;i< this.lv.Items.Count; i++)
            {
                ...
                this.PasswordRecord.Add(new PasswordRecord.PasswordInfo()
                {
                    ...
                    Mobile = item.SubItems[4].Text,
                    Mail = item.SubItems[5].Text,
                    Memo = item.SubItems[6].Text
